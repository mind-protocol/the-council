...
- Sens dans l'export : `DesertRanger` → `DucaleTechie`
- Force héritée : **0**
- Confiance héritée : **51**
- Statut : Active
- Palier : non renseigne
- Créée : 12/6/2025 8:26pm
- Mise à jour : 12/6/2025 8:26pm
- Dernière interaction : 12/6/2025 8:26pm
...
```text
activity_encounter_initiated_opener_success_ducaletechie_opened_conversation_with_desertranger_at_{"lat":_45.425098802748686,_"lng":_12.362717959741016}.
```
