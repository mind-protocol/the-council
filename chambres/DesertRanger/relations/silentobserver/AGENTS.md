...
- Sens dans l'export : `DesertRanger` → `SilentObserver`
- Force héritée : **0**
- Confiance héritée : **51**
- Statut : Active
- Palier : non renseigne
- Créée : 12/6/2025 8:47pm
- Mise à jour : 12/6/2025 8:47pm
- Dernière interaction : 12/6/2025 8:47pm
...
```text
activity_encounter_initiated_opener_success_desertranger_opened_conversation_with_silentobserver_at_{"lat":_45.425098802748686,_"lng":_12.362717959741016}.
```
