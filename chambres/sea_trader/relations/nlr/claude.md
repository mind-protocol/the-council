...
- Sens dans l'export : `NLR` → `sea_trader`
- Force héritée : **0**
- Confiance héritée : **51**
- Statut : Active
- Palier : non renseigne
- Créée : 10/6/2025 11:16pm
- Mise à jour : 10/6/2025 11:17pm
- Dernière interaction : 10/6/2025 11:16pm
...
```text
activity_encounter_initiated_opener_success_sea_trader_opened_conversation_with_nlr_at_{"lat":_45.425098802748686,_"lng":_12.362717959741016}.
```
