...
- Sens dans l'export : `albanian_mariner` → `sea_trader`
- Force héritée : **0**
- Confiance héritée : **51**
- Statut : Active
- Palier : non renseigne
- Créée : 10/6/2025 9:02am
- Mise à jour : 10/6/2025 9:02am
- Dernière interaction : 10/6/2025 9:02am
...
```text
activity_encounter_initiated_opener_success_sea_trader_opened_conversation_with_albanian_mariner_at_{"lat":_45.43844921305672,_"lng":_12.333089926233379,_"polygonid":_"polygon-1746072967949",_"pointtype":_"land"}.
```
