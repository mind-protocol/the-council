...
- Sens dans l'export : `BarbarigoCadet` → `sicily_mariner`
- Force héritée : **0**
- Confiance héritée : **53**
- Statut : Active
- Palier : non renseigne
- Créée : 16/6/2025 10:02pm
- Mise à jour : 16/6/2025 10:17pm
- Dernière interaction : 16/6/2025 10:17pm
...
```text
activity_fetch_galley_stock_success, activity_fetch_galley_stock_success, activity_fetch_galley_stock_failure_galley_empty
```
