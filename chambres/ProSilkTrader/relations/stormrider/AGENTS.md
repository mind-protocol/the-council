...
- Sens dans l'export : `ProSilkTrader` → `StormRider`
- Force héritée : **0**
- Confiance héritée : **51**
- Statut : Active
- Palier : non renseigne
- Créée : 10/6/2025 8:49pm
- Mise à jour : 10/6/2025 8:49pm
- Dernière interaction : 10/6/2025 8:49pm
...
```text
activity_encounter_initiated_opener_success_prosilktrader_opened_conversation_with_stormrider_at_{"lat":_45.425098802748686,_"lng":_12.362717959741016}.
```
