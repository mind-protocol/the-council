...
- Sens dans l'export : `BasstheWhale` → `VenicePhotographer`
- Force héritée : **0**
...
```text
activity_encounter_initiated_opener_success_bassthewhale_opened_conversation_with_venicephotographer_at_{"lat":_45.4408725,_"lng":_12.3303685}.
```
