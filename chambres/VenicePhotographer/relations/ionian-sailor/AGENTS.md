...
- Sens dans l'export : `VenicePhotographer` → `ionian_sailor`
- Force héritée : **0**
- Confiance héritée : **44**
- Statut : Active
- Palier : non renseigne
- Créée : 8/6/2025 6:04am
...
```text
activity_fetch_pickup_failure_nothing_to_pickup, activity_fetch_galley_stock_failure_galley_empty, activity_fetch_galley_stock_success, activity_fetch_galley_stock_failure_galley_empty
```
