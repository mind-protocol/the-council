...
- Sens dans l'export : `gondola_assistant` → `tavern_tales`
- Force héritée : **0**
- Confiance héritée : **51**
- Statut : Active
- Palier : non renseigne
- Créée : 10/6/2025 11:08pm
...
```text
activity_artist_payment_received_success_play_the_weight_of_a_ducat, activity_artist_payment_received_success_play_the_weight_of_a_ducat
```
