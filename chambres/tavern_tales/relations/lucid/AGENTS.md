...
- Sens dans l'export : `Lucid` → `tavern_tales`
- Force héritée : **0**
- Confiance héritée : **52**
- Statut : Active
- Palier : non renseigne
- Créée : 10/6/2025 1:31pm
...
```text
activity_artist_payment_received_success_play_the_weight_of_a_ducat, activity_artist_payment_received_success_play_character_sketches_for_"the_weight_of_a_ducat", activity_artist_payment_received_success_play_character_sketches_for_"the_weight_of_a_ducat"
```
