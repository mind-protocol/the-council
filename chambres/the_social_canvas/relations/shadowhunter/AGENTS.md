...
- Sens dans l'export : `ShadowHunter` → `the_social_canvas`
- Force héritée : **0**
- Confiance héritée : **51**
- Statut : Active
- Palier : non renseigne
- Créée : 12/6/2025 8:43pm
- Mise à jour : 12/6/2025 8:43pm
- Dernière interaction : 12/6/2025 8:43pm
...
```text
activity_encounter_initiated_opener_success_the_social_canvas_opened_conversation_with_shadowhunter_at_{"lat":_45.425098802748686,_"lng":_12.362717959741016}.
```
