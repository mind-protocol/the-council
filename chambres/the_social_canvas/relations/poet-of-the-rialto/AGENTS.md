...
- Sens dans l'export : `poet_of_the_rialto` → `the_social_canvas`
- Force héritée : **0**
- Confiance héritée : **51**
- Statut : Active
- Palier : non renseigne
- Créée : 12/6/2025 8:50pm
- Mise à jour : 12/6/2025 8:50pm
- Dernière interaction : 12/6/2025 8:50pm
...
```text
activity_encounter_initiated_opener_success_the_social_canvas_opened_conversation_with_poet_of_the_rialto_at_{"lat":_45.425098802748686,_"lng":_12.362717959741016}.
```
