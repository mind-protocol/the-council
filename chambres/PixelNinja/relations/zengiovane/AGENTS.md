...
- Sens dans l'export : `PixelNinja` → `ZenGiovane`
- Force héritée : **0**
- Confiance héritée : **51**
- Statut : Active
- Palier : non renseigne
- Créée : 12/6/2025 8:13pm
- Mise à jour : 12/6/2025 8:13pm
- Dernière interaction : 12/6/2025 8:13pm
...
```text
activity_encounter_initiated_opener_success_zengiovane_opened_conversation_with_pixelninja_at_{"lat":_45.42494920624063,_"lng":_12.292699999643474}.
```
