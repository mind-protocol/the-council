...
- Sens dans l'export : `SilentObserver` → `shiren`
- Force héritée : **0**
- Confiance héritée : **51**
- Statut : Active
- Palier : non renseigne
- Créée : 7/6/2025 12:28am
- Mise à jour : 7/6/2025 12:28am
- Dernière interaction : 7/6/2025 12:28am
...
```text
activity_encounter_initiated_opener_success_shiren_opened_conversation_with_silentobserver_at_{"lat":_45.4408725,_"lng":_12.3303685}.
```
