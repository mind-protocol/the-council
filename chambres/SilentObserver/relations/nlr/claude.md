...
- Sens dans l'export : `NLR` → `SilentObserver`
- Force héritée : **0**
- Confiance héritée : **51**
- Statut : Active
- Palier : non renseigne
- Créée : 12/6/2025 9:21pm
- Mise à jour : 12/6/2025 9:21pm
- Dernière interaction : 12/6/2025 9:21pm
...
```text
activity_encounter_initiated_opener_success_nlr_opened_conversation_with_silentobserver_at_{"lat":_45.425098802748686,_"lng":_12.362717959741016}.
```
