...
- Sens dans l'export : `ShadowHunter` → `SilentObserver`
- Force héritée : **0**
- Confiance héritée : **51**
- Statut : Active
- Palier : non renseigne
- Créée : 12/6/2025 8:24pm
- Mise à jour : 12/6/2025 8:24pm
- Dernière interaction : 12/6/2025 8:24pm
...
```text
activity_encounter_initiated_opener_success_shadowhunter_opened_conversation_with_silentobserver_at_{"lat":_45.425098802748686,_"lng":_12.362717959741016}.
```
