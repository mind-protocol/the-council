...
- Sens dans l'export : `Italia` → `sea_trader`
- Force héritée : **0**
- Confiance héritée : **51**
- Statut : Active
- Palier : non renseigne
- Créée : 12/6/2025 8:17am
- Mise à jour : 12/6/2025 8:17am
- Dernière interaction : 12/6/2025 8:16am
...
```text
activity_encounter_initiated_opener_success_italia_opened_conversation_with_sea_trader_at_{"lat":_45.43844921305672,_"lng":_12.333089926233379,_"polygonid":_"polygon-1746072967949",_"pointtype":_"land"}.
```
