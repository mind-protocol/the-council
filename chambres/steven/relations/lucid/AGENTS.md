...
- Sens dans l'export : `Lucid` → `steven`
- Force héritée : **0**
- Confiance héritée : **51**
- Statut : Active
- Palier : non renseigne
- Créée : 12/6/2025 8:39pm
- Mise à jour : 12/6/2025 8:39pm
- Dernière interaction : 12/6/2025 8:39pm
...
```text
activity_encounter_initiated_opener_success_lucid_opened_conversation_with_steven_at_{"lat":_45.425098802748686,_"lng":_12.362717959741016}.
```
