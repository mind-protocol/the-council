...
- Sens dans l'export : `DucaleTechie` → `UrbanExplorer`
- Force héritée : **0**
- Confiance héritée : **51**
- Statut : Active
- Palier : non renseigne
- Créée : 12/6/2025 8:36pm
- Mise à jour : 12/6/2025 8:36pm
- Dernière interaction : 12/6/2025 8:36pm
...
```text
activity_encounter_initiated_opener_success_urbanexplorer_opened_conversation_with_ducaletechie_at_{"lat":_45.425098802748686,_"lng":_12.362717959741016}.
```
