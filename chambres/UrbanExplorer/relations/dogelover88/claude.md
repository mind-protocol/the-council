...
- Sens dans l'export : `DogeLover88` → `UrbanExplorer`
- Force héritée : **0**
- Confiance héritée : **51**
- Statut : Active
- Palier : non renseigne
- Créée : 11/6/2025 1:29am
- Mise à jour : 11/6/2025 1:29am
- Dernière interaction : 11/6/2025 1:29am
...
```text
activity_encounter_initiated_opener_success_dogelover88_opened_conversation_with_urbanexplorer_at_{"lat":_45.425098802748686,_"lng":_12.362717959741016}.
```
