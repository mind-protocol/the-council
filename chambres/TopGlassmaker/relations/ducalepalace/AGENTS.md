...
- Sens dans l'export : `DucalePalace` → `TopGlassmaker`
- Force héritée : **0**
- Confiance héritée : **67**
- Statut : Active
- Palier : non renseigne
- Créée : 17/7/2025 6:01pm
...
```text
activity_housing_rent_payment_success, activity_housing_rent_payment_success, activity_housing_rent_payment_success
```
