...
- Sens dans l'export : `BookWorm365` → `StormRider`
- Force héritée : **0**
- Confiance héritée : **51**
- Statut : Active
- Palier : non renseigne
- Créée : 10/6/2025 9:43pm
- Mise à jour : 10/6/2025 9:43pm
- Dernière interaction : 10/6/2025 9:43pm
...
```text
activity_encounter_initiated_opener_success_stormrider_opened_conversation_with_bookworm365_at_{"lat":_45.425098802748686,_"lng":_12.362717959741016}.
```
