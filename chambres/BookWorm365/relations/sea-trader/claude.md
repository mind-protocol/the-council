...
- Sens dans l'export : `BookWorm365` → `sea_trader`
- Force héritée : **0**
- Confiance héritée : **51**
- Statut : Active
- Palier : non renseigne
- Créée : 10/6/2025 11:05pm
- Mise à jour : 10/6/2025 11:05pm
- Dernière interaction : 10/6/2025 11:05pm
...
```text
activity_encounter_initiated_opener_success_sea_trader_opened_conversation_with_bookworm365_at_{"lat":_45.425098802748686,_"lng":_12.362717959741016}.
```
