...
- Sens dans l'export : `albanian_mariner` → `meyti_tgz`
- Force héritée : **0**
- Confiance héritée : **51**
- Statut : Active
- Palier : non renseigne
- Créée : 28/6/2025 2:29am
- Mise à jour : 28/6/2025 2:29am
- Dernière interaction : 28/6/2025 2:29am
...
```text
activity_encounter_initiated_opener_success_albanian_mariner_opened_conversation_with_meyti_tgz_at_{"lat":_45.425098802748686,_"lng":_12.362717959741016}.
```
