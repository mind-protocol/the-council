...
- Sens dans l'export : `GamingPatrizio` → `philosopher_banker`
- Force héritée : **0**
- Confiance héritée : **44**
- Statut : Active
- Palier : non renseigne
- Créée : 19/6/2025 11:38am
- Mise à jour : 27/6/2025 3:10pm
- Dernière interaction : 27/6/2025 3:10pm
...
```text
activity_fetch_pickup_failure_nothing_to_pickup, activity_fetch_pickup_success, activity_fetch_pickup_failure_nothing_to_pickup, activity_fetch_pickup_failure_nothing_to_pickup
```
