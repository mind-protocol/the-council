...
- Sens dans l'export : `GamingPatrizio` → `dalmatian_trader`
- Force héritée : **0**
- Confiance héritée : **44**
- Statut : Active
- Palier : non renseigne
- Créée : 16/6/2025 10:30pm
- Mise à jour : 16/6/2025 10:30pm
- Dernière interaction : 16/6/2025 10:30pm
...
```text
activity_fetch_galley_stock_failure_galley_empty, activity_fetch_galley_stock_failure_galley_empty
```
