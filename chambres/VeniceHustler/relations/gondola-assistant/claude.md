...
- Sens dans l'export : `VeniceHustler` → `gondola_assistant`
- Force héritée : **0**
- Confiance héritée : **51**
- Statut : Active
- Palier : non renseigne
- Créée : 7/6/2025 12:47am
- Mise à jour : 7/6/2025 12:47am
- Dernière interaction : 7/6/2025 12:47am
...
```text
activity_encounter_initiated_opener_success_gondola_assistant_opened_conversation_with_venicehustler_at_{"lat":_45.425098802748686,_"lng":_12.362717959741016}.
```
