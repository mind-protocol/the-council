...
- Sens dans l'export : `John_Jeffries` → `dkaya`
- Force héritée : **0**
- Confiance héritée : **51**
- Statut : Active
- Palier : non renseigne
- Créée : 10/6/2025 10:10pm
- Mise à jour : 10/6/2025 10:10pm
- Dernière interaction : 10/6/2025 10:10pm
...
```text
activity_encounter_initiated_opener_success_dkaya_opened_conversation_with_john_jeffries_at_{"lat":_45.439276,_"lng":_12.339331}.
```
