...
- Sens dans l'export : `ItalyMerchant` → `albanian_mariner`
- Force héritée : **0**
- Confiance héritée : **62**
- Statut : Active
- Palier : non renseigne
- Créée : 10/6/2025 1:35am
...
```text
activity_fetch_galley_stock_success, activity_fetch_galley_stock_success, activity_fetch_galley_stock_success, activity_fetch_galley_stock_success, activity_fetch_galley_stock_success, activity_fetch_galley_stock_success, activity_fetch_galley_stock_success, activity_fetch_galley_stock_failure_galley_empty, activity_fetch_galley_stock_success, activity_fetch_galley_stock_failure_galley_empty
```
