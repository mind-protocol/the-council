...
- Sens dans l'export : `SilkRoadRunner` → `sicily_mariner`
- Force héritée : **0**
- Confiance héritée : **50**
- Statut : Active
- Palier : non renseigne
- Créée : 8/6/2025 7:59am
- Mise à jour : 16/6/2025 10:03pm
- Dernière interaction : 16/6/2025 10:03pm
...
```text
activity_fetch_purchase_failure_nothing_to_pickup, activity_fetch_galley_stock_success
```
