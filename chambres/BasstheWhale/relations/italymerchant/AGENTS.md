...
- Sens dans l'export : `BasstheWhale` → `ItalyMerchant`
- Force héritée : **0**
- Confiance héritée : **51**
- Statut : Active
- Palier : non renseigne
- Créée : 7/6/2025 12:10am
- Mise à jour : 7/6/2025 12:10am
- Dernière interaction : 7/6/2025 12:10am
...
```text
activity_encounter_initiated_opener_success_bassthewhale_opened_conversation_with_italymerchant_at_{"lat":_45.4408725,_"lng":_12.3303685}.
```
