...
- Sens dans l'export : `BookishMerchant` → `ItalyMerchant`
- Force héritée : **0**
- Confiance héritée : **47**
- Statut : Active
- Palier : non renseigne
- Créée : 7/6/2025 12:26am
- Mise à jour : 27/6/2025 4:43pm
- Dernière interaction : 27/6/2025 4:43pm
...
```text
activity_encounter_initiated_opener_success_italymerchant_opened_conversation_with_bookishmerchant_at_{"lat":_45.4408725,_"lng":_12.3303685}., activity_fetch_pickup_failure_nothing_to_pickup
```
