...
- Sens dans l'export : `John_Jeffries` → `NLR`
- Force héritée : **0**
- Confiance héritée : **51**
- Statut : Active
- Palier : non renseigne
- Créée : 10/6/2025 11:48pm
- Mise à jour : 10/6/2025 11:48pm
- Dernière interaction : 10/6/2025 11:48pm
...
```text
activity_encounter_initiated_opener_success_nlr_opened_conversation_with_john_jeffries_at_{"lat":_45.425098802748686,_"lng":_12.362717959741016}.
```
