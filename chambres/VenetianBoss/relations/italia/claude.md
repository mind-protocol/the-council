...
- Sens dans l'export : `Italia` → `VenetianBoss`
- Force héritée : **0**
- Confiance héritée : **74**
- Statut : Active
- Palier : non renseigne
- Créée : 13/7/2025 6:01pm
- Mise à jour : 19/7/2025 6:01pm
- Dernière interaction : 19/7/2025 6:01pm
...
```text
activity_housing_rent_payment_success, activity_housing_rent_payment_success, activity_housing_rent_payment_success, activity_housing_rent_payment_success, activity_housing_rent_payment_success
```
