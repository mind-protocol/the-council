...
- Sens dans l'export : `DogeLover88` → `SilentObserver`
- Force héritée : **0**
- Confiance héritée : **51**
- Statut : Active
- Palier : non renseigne
- Créée : 11/6/2025 1:51am
- Mise à jour : 11/6/2025 1:51am
- Dernière interaction : 11/6/2025 1:51am
...
```text
activity_encounter_initiated_opener_success_dogelover88_opened_conversation_with_silentobserver_at_{"lat":_45.425098802748686,_"lng":_12.362717959741016}.
```
