...
- Sens dans l'export : `Debug42` → `NLR`
- Force héritée : **0**
- Confiance héritée : **51**
- Statut : Active
- Palier : non renseigne
- Créée : 10/6/2025 11:51pm
- Mise à jour : 10/6/2025 11:51pm
- Dernière interaction : 10/6/2025 11:51pm
...
```text
activity_encounter_initiated_opener_success_nlr_opened_conversation_with_debug42_at_{"lat":_45.425098802748686,_"lng":_12.362717959741016}.
```
