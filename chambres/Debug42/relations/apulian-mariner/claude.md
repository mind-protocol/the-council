...
- Sens dans l'export : `Debug42` → `apulian_mariner`
- Force héritée : **0**
- Confiance héritée : **51**
- Statut : Active
- Palier : non renseigne
- Créée : 10/6/2025 11:41pm
- Mise à jour : 10/6/2025 11:41pm
- Dernière interaction : 10/6/2025 11:41pm
...
```text
activity_encounter_initiated_opener_success_debug42_opened_conversation_with_apulian_mariner_at_{"lat":_45.425098802748686,_"lng":_12.362717959741016}.
```
