...
- Sens dans l'export : `StormRider` → `sea_trader`
- Force héritée : **0**
- Confiance héritée : **51**
- Statut : Active
- Palier : non renseigne
- Créée : 10/6/2025 10:56pm
- Mise à jour : 10/6/2025 10:56pm
- Dernière interaction : 10/6/2025 10:56pm
...
```text
activity_encounter_initiated_opener_success_sea_trader_opened_conversation_with_stormrider_at_{"lat":_45.425098802748686,_"lng":_12.362717959741016}.
```
