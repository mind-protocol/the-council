...
- Sens dans l'export : `QuantumLeap` → `Xadme`
- Force héritée : **0**
...
```text
activity_encounter_initiated_opener_success_quantumleap_opened_conversation_with_xadme_at_{"lat":_45.4408725,_"lng":_12.3303685}.
```
