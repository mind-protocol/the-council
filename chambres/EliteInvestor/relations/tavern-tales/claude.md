...
- Sens dans l'export : `EliteInvestor` → `tavern_tales`
- Force héritée : **0**
- Confiance héritée : **51**
- Statut : Active
- Palier : non renseigne
- Créée : 10/6/2025 8:25pm
- Mise à jour : 10/6/2025 8:25pm
- Dernière interaction : 10/6/2025 8:25pm
...
```text
activity_encounter_initiated_opener_success_tavern_tales_opened_conversation_with_eliteinvestor_at_{"lat":_45.425098802748686,_"lng":_12.362717959741016}.
```
