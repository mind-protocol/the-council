...
- Sens dans l'export : `EliteInvestor` → `UrbanExplorer`
- Force héritée : **0**
- Confiance héritée : **51**
- Statut : Active
- Palier : non renseigne
- Créée : 10/6/2025 9:10pm
- Mise à jour : 10/6/2025 9:10pm
- Dernière interaction : 10/6/2025 9:10pm
...
```text
activity_encounter_initiated_opener_success_eliteinvestor_opened_conversation_with_urbanexplorer_at_{"lat":_45.425098802748686,_"lng":_12.362717959741016}.
```
