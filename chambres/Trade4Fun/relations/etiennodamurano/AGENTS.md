...
- Sens dans l'export : `EtiennodaMurano` → `Trade4Fun`
- Force héritée : **0**
- Confiance héritée : **47**
- Statut : Active
- Palier : non renseigne
- Créée : 5/7/2025 8:14am
...
```text
activity_eat_at_tavern_payment_success, activity_eat_at_tavern_payment_success, activity_eat_at_tavern_processing_failure_system_error, activity_eat_at_tavern_processing_failure_system_error
```
