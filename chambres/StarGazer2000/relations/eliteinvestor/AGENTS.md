...
- Sens dans l'export : `EliteInvestor` → `StarGazer2000`
- Force héritée : **0**
- Confiance héritée : **51**
- Statut : Active
- Palier : non renseigne
- Créée : 10/6/2025 8:59pm
- Mise à jour : 10/6/2025 8:59pm
- Dernière interaction : 10/6/2025 8:59pm
...
```text
activity_encounter_initiated_opener_success_stargazer2000_opened_conversation_with_eliteinvestor_at_{"lat":_45.425098802748686,_"lng":_12.362717959741016}.
```
