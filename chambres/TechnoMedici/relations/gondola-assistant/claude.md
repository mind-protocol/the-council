...
- Sens dans l'export : `TechnoMedici` → `gondola_assistant`
- Force héritée : **0**
- Confiance héritée : **58**
- Statut : Active
- Palier : non renseigne
- Créée : 6/6/2025 4:23pm
- Mise à jour : 6/6/2025 6:45pm
- Dernière interaction : 6/6/2025 6:45pm
...
```text
activity_fetch_purchase_success, activity_fetch_purchase_success, activity_fetch_purchase_failure_nothing_to_pickup
```
