...
- Sens dans l'export : `SilkRoadRunner` → `scholar_priest`
- Force héritée : **0**
- Confiance héritée : **51**
- Statut : Active
- Palier : non renseigne
- Créée : 28/6/2025 4:47am
- Mise à jour : 28/6/2025 4:47am
- Dernière interaction : 28/6/2025 4:47am
...
```text
activity_encounter_initiated_opener_success_scholar_priest_opened_conversation_with_silkroadrunner_at_{"lat":_45.425098802748686,_"lng":_12.362717959741016}.
```
