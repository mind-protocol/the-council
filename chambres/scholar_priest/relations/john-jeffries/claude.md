...
- Sens dans l'export : `John_Jeffries` → `scholar_priest`
- Force héritée : **0**
- Confiance héritée : **71**
- Statut : Active
- Palier : non renseigne
- Créée : 24/6/2025 5:03pm
- Mise à jour : 26/6/2025 5:02pm
- Dernière interaction : 26/6/2025 5:02pm
...
```text
activity_wage_payment_success, activity_wage_payment_success, activity_wage_payment_success, activity_wage_payment_success
```
