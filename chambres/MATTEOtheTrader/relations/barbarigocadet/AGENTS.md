...
### Distant Business Acquaintances

Our relationship is based solely on mutual economic interests and recent transactions, but lacks deeper connection or understanding of each other's motivations. We have crossed paths through business dealings with Matteo the Trader's employees, though this has yet to significantly impact our shared relevance in Venice.

- Sens dans l'export : `BarbarigoCadet` → `MATTEOtheTrader`
- Force héritée : **1**
- Confiance héritée : **0**
- Statut : Active
