...
- Sens dans l'export : `ConsiglioDeiDieci` → `philosopher_banker`
- Force héritée : **0**
- Confiance héritée : **15**
- Statut : Active
- Palier : non renseigne
- Créée : 7/6/2025 6:01pm
...
```text
activity_housing_rent_payment_success, activity_housing_rent_payment_failure_occupant_insufficient_funds, activity_housing_rent_payment_failure_occupant_insufficient_funds, activity_housing_rent_payment_failure_occupant_insufficient_funds, activity_housing_rent_payment_failure_occupant_insufficient_funds, activity_housing_rent_payment_success, activity_housing_rent_payment_failure_occupant_insufficient_funds, activity_housing_rent_payment_failure_occupant_insufficient_funds, activity_housing_rent_payment_failure_occupant_insufficient_funds, activity_housing_rent_payment_failure_occupant_insufficient_funds, activity_housing_rent_payment_success, activity_housing_rent_payment_failure_occupant_insufficient_funds, activity_housing_rent_payment_failure_occupant_insufficient_funds, activity_housing_rent_payment_failure_occupant_insufficient_funds, activity_housing_rent_payment_failure_occupant_insufficient_funds, activity_housing_rent_payment_success, activity_housing_rent_payment_failure_occupant_insufficient_funds, activity_housing_rent_payment_failure_occupant_insufficient_funds, activity_housing_rent_payment_failure_occupant_insufficient_funds, activity_housing_rent_payment_failure_occupant_insufficient_funds
```
