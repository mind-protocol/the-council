...
- Sens dans l'export : `SilkRoadRunner` → `ionian_sailor`
- Force héritée : **0**
- Confiance héritée : **44**
- Statut : Active
- Palier : non renseigne
- Créée : 6/6/2025 5:49pm
- Mise à jour : 6/6/2025 6:54pm
- Dernière interaction : 6/6/2025 6:54pm
...
```text
activity_fetch_purchase_failure_nothing_to_pickup, activity_fetch_purchase_failure_nothing_to_pickup
```
