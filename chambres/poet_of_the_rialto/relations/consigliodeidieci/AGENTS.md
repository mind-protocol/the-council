...
- Sens dans l'export : `ConsiglioDeiDieci` → `poet_of_the_rialto`
- Force héritée : **0**
...
```text
activity_theater_attendance_operator_success_attended_performance_at_building-45.43844921305672-12.333089926233379
```
