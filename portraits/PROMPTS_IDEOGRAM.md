...
```
Painted character portrait, classical oil painting on aged canvas, dark fantasy medieval court, bust framing showing head and shoulders, three-quarter view, neutral dark background, lit by warm candlelight from one side, dramatic chiaroscuro, muted regal color palette, visible fine brushwork, dignified and somber mood, no text, no watermark, no frame.
```
