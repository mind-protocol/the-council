...
#
# Usage :
#     python scripts/analyse/croisement.py --contre maison-hightower
#     python scripts/analyse/croisement.py --contre maison-hightower --jours 45
#     python scripts/analyse/croisement.py --contre maison-hightower --vrai
#     python scripts/analyse/croisement.py --contre maison-baratheon --detail
import argparse
import collections
import io
import json
