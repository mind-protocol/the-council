...
Usage :
    python scripts/scorer_activation_hightower.py
    python scripts/scorer_activation_hightower.py --tour-secondes 300
    python scripts/scorer_activation_hightower.py --minimum 85
    python scripts/scorer_activation_hightower.py --auto-test
"""
