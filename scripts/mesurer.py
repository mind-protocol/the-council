...
#
# Usage :
#   python scripts/mesurer.py                 le jour du monde
#   python scripts/mesurer.py --jours 3       la fenetre de trois jours
#   python scripts/mesurer.py --qui gerardys  un homme seul
#   python scripts/mesurer.py --orphelines    les repliques sans amont, en clair
import argparse
import io
import json
import math
