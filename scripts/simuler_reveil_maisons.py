...
Usage :
    python scripts/simuler_reveil_maisons.py
    python scripts/simuler_reveil_maisons.py --tours 100 --parallele 1
    python scripts/simuler_reveil_maisons.py --fraction-depense 0.6
    python scripts/simuler_reveil_maisons.py --json rapport.json
"""
