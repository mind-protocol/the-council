...
Usage :
    python scripts/chercher_activation_hightower.py
    python scripts/chercher_activation_hightower.py --top 20
    python scripts/chercher_activation_hightower.py --auto-test
"""
