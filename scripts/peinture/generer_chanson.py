...
#
# Usage :
#     python scripts/peinture/generer_chanson.py musiques/le-manteau-d-or.md
#     python scripts/peinture/generer_chanson.py --toutes          (toutes les fiches sans audio)
#     python scripts/peinture/generer_chanson.py <fiche> --sec     (montre ce qui partirait, n'appelle rien)
#
