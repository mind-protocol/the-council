...
les medaillons placeholder qu'il remplace. Rien d'autre a brancher.
    ...
    python scripts/peinture/medaillons.py            # etat des lieux, n'ecrit rien
    python scripts/peinture/medaillons.py --vraiment # fabrique
    python scripts/peinture/medaillons.py --vraiment --seulement rhaenyra,daemon
