...
# Usage : python scripts/peinture/gen_voix.py [id ...]          (sans argument : tous les actifs)
#         python scripts/peinture/gen_voix.py --refaire <id>    (redessine trois variantes, garde la voix en place)
#         python scripts/peinture/gen_voix.py --choisir <id> <n>(adopte la variante n déjà auditionnée)
#         python scripts/peinture/gen_voix.py --essai <id>      (extraits seulement, ne crée rien)
