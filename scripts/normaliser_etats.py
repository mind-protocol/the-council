...
Usage :
    python scripts/normaliser_etats.py                 rapport à blanc
    python scripts/normaliser_etats.py --rapport f.md   le poser dans un fichier
    python scripts/normaliser_etats.py --vraiment       applique les CLAIRS seuls
