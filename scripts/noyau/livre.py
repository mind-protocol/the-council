...
#
# Usage :
#     python scripts/noyau/livre.py --pour le-sanglier --index
#     python scripts/noyau/livre.py --pour le-sanglier --ouvrir registre-des-offices
#     python scripts/noyau/livre.py --pour le-sanglier --ouvrir X --cherche "porte de mer"
import argparse
import io
import json
import os
...
def main():
    ...
    if a.ouvrir:
        ...
        raise SystemExit(
            ...
            u"  python scripts/noyau/livre.py --pour %s --index"
            % (a.ouvrir, a.pour))
