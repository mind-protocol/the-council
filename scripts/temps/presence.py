# -*- coding: utf-8 -*-
# PRESENCE — où se tient chacun DANS le château, à la minute près — et par où il y va.
#
...
# Le quartier du joueur, les creux et la CLI vivent dans
# presence_quartier.py (meme container) ; on les rattache ici pour que
# `presence.quartier`, `presence.creux` et la commande restent au meme
# endroit qu'avant.
from temps.presence_quartier import (  # noqa: E402,F401
    ancres, quartier, creux, MINUTES_MINIMUM, noms, dire, main)
