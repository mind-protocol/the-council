...
Usage :
    python scripts/plan/reparer_renvois.py               à blanc — n'écrit rien
    python scripts/plan/reparer_renvois.py --vraiment    écrit, après sauvegarde
    python scripts/plan/reparer_renvois.py --affaire "fenetre"   une affaire
