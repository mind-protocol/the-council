...
cahier qui n'a pas de colonne d'action.
    ...
    python scripts/plan/dater_plan.py                a blanc, c'est le defaut
    python scripts/plan/dater_plan.py --affaire ral  a blanc, une affaire seulement
    python scripts/plan/dater_plan.py --detail       chaque ligne, avec sa source
    python scripts/plan/dater_plan.py --vraiment     ecrit, avec sauvegarde horodatee
