...
Usage :
    python scripts/plan/scinder_moyens.py                à blanc — n'écrit rien
    python scripts/plan/scinder_moyens.py --rapport f.md le poser dans un fichier
    python scripts/plan/scinder_moyens.py --vraiment     écrit, après sauvegarde
"""
import io
import os
import re
