# -*- coding: utf-8 -*-
# SEED_FLUX — (re)initialise etat/flux.jsonl : le beat d'ouverture (le conseil
# noir), au format flux append-only. DESTRUCTIF : il REECRIT le fil entier —
# c'est son emploi, et il ne part que par main(), jamais au chargement.
import json, io, os
...
def main():
    """Ecrit le beat d'ouverture. La seule fonction : importer ce module est inerte."""
