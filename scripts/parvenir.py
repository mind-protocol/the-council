...
#
# Usage :
#     python scripts/parvenir.py 71002                 une piece
#     python scripts/parvenir.py --en-face             tous les verrous d'en face
#     python scripts/parvenir.py --affaires            les journees d'hommes
#     python scripts/parvenir.py --muets               ce qui n'atteint personne
#     python scripts/parvenir.py 71002 --par-ou        le chemin, bouche par bouche
#     python scripts/parvenir.py --en-face --json
import argparse
import collections
import heapq
import io
